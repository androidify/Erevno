...
<div>
<table cellspacing="10" id="innerContent" style="text-align:center;"><tr><th>Rank</th><th>Username</th><th>Level</th></tr>
<?php
		
		$sql="Select username, level, leveldate from userdata order by level DESC, leveldate";
		$res=mysql_query($sql);
		$i=1;
		while($r=mysql_fetch_array($res)) {
	 			 ...
	 			 $l=$r["level"];
				 $d=new DateTime($r["leveldate"]);
				 $date1 = new DateTime(null, new DateTimeZone('Asia/Calcutta'));
				 $date1= new DateTime($date1->format('Y-m-d H:i:sP'));
