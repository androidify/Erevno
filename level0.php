...
<div id="fixedBorder">
<a href="index.php">Home</a><a href="instructions.php">Instructions</a><a href="leaderboard.php">Leaderboard</a><a href="levelselect.php">Select Level</a><a href="https://www.facebook.com/notes/sorcerers-of-intellect/level-1-discussion-page/357855554242514" target="_blank">Hints</a>
...
<div id="imageArea">
<p style="text-align:center; font-size:40px">Click <a href="#" target="_blank" style="color: #FFE960;">here</a> to begin your quest!!! </p><br/>
...
<input id="key" type="hidden" value="zero"/>
&nbsp;
