...
<div id="imageArea">
<table style="color:white;text-align:center; width:700px;margin:0 auto;">
<tr>
<td>1. </td><td style="font-size:40px"> ?</td></tr>
	
	<tr><td>2. </td><td><img src="images/moon.png" width="150"> </td></tr>
	
	
	<tr><td>3.</td><td><span style="color:black; font-size:50px;">BACK</span></td></tr>
	
	
	<tr><td>4. </td><td><img src="images/movie.jpg" width="200" height="250"></td></tr>
</table>
...
<input id="key" type="hidden" value="15"/>
&nbsp;
