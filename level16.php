...
<p style="text-align:center;font-size:30px"> As per the rules of the game, we have to inform <br/>
that you have been disqualified from this game.<br/>
This has been necessitated owing to the fact that<br/>
we have noticed a discrepancy in the entered data<br/>
therefore you are not eligible to go to the next level.</p>

</div>
<br /><br />
<p style="text-align:center;">
Enter Your Answer Here: &nbsp;&nbsp;&nbsp;<input type="text" id="validate"/>
<input id="key" type="hidden" value="16"/>
&nbsp;
