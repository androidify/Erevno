...
<!--#-->
<!--Im shure im nineth victom to committ sucide in this forrest.-->
<div id="contentWrap">
...
<div id="imageArea">
	...
	<table style="color:white;text-align:center; width:700px;margin:0 auto;"> <tr><td>&nbsp;</td><td><img src="images/haha.jpg" width="250"></td>
	
	
<td>	 <p style="text-align:center; font-size:200px">A</p></td><td><img src="images/horror.jpg" width="250"></td></tr>
</table>
<br />
...
<input id="key" type="hidden" value="19"/>
&nbsp;
