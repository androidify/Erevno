...
<!--8 2 22 88 555 2 777 33 222 8 2-->
<div id="topfixed"><div id="fixedCont">
<a id="logoutNew" style="" href="logout.php">Logout</a>
<div id="fixedBorder">
<a href="index.php">Home</a><a href="instructions.php">Instructions</a><a href="leaderboard.php">Leaderboard</a><a href="levelselect.php">Select Level</a><a href="https://www.facebook.com/note.php?note_id=357855864242483" target="_blank">Hints</a>
...
<div id="imageArea">
	...
	<img src="images/man2.jpg" width="200" >
	
	
	<img src="images/man3.jpg" width="180" height="280">
<br /><br />
...
<input id="key" type="hidden" value="2"/>
&nbsp;
