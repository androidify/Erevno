...
<div id="imageArea">
	...
	<img src="images/number.jpg" width="300">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	
	<img src="images/minus.png" width="190">
<br />	<br />


</div>

<p style="text-align:center; font-size:70px"> 4824347 </p><br/>
<p style="text-align:center;">
Enter Your Answer Here: &nbsp;&nbsp;&nbsp;<input type="text" id="validate"/>
<input id="key" type="hidden" value="22"/>
&nbsp;
