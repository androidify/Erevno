...
<a href="https://www.facebook.com/note.php?note_id=357856470909089" target="_blank">Hints</a>
</div>
...
<br />	
	<img src="images/think.jpg" width="250">


</div>
<br />
<p style="text-align:center; font-size:20px"> Bridgeman was born at Nottingham Place, Marylebone, London, <br/>
the eldest son of George Bridgeman, 2nd Earl of Bradford and his<br/>
wife Georgina Elizabeth Moncreiffe, daughter of Sir Thomas Moncreiffe, <br/>
5th Baronet.He was educated at Harrow and Trinity College, Cambridge.<br/> 
He became known by the courtesy title Viscount Newport when his father <br/>
succeeded in the earldom of Bradford in 1825.</p><br/><br/>

<p style="text-align:center;">
Enter Your Answer Here: &nbsp;&nbsp;&nbsp;<input type="text" id="validate"/>
<input id="key" type="hidden" value="8"/>
&nbsp;
