...
<a href="https://www.facebook.com/note.php?note_id=357856597575743" target="_blank">Hints</a>
</div>
...
<div id="imageArea">
<p style="text-align:center; font-size:70px">First Use</p><br/>
	
	<img src="images/great1.jpg" width="220">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	
	<img src="images/great2.jpg" width="310">
<br /><br />
</div>

<p style="text-align:center;">
Enter Your Answer Here: &nbsp;&nbsp;&nbsp;<input type="text" id="validate"/>
<input id="key" type="hidden" value="9"/>
&nbsp;
